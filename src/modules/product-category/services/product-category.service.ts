...
const supplierCategoryService = {
  ...
  create: (data: CreateProductCategoryInterface) => api.post('products-category', data),
  update: (id: number, data: UpdateProductCategoryInterface) => api.put(`products-category/${id}`, data),
