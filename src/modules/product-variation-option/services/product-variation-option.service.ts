...
const productVariationOptionService = {
  ...
  create: (data: CreateProductVariationOptionInterface) => api.post('/product-variation-options', data),
  update: (id: number, data: UpdateProductCategoryOptionInterface) => api.put(`/product-variation-options/${id}`, data),
