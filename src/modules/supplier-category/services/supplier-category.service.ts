...
const supplierCategoryService = {
  ...
  create: (data: CreateSupplierCategoryInterface) => api.post('suppliers-category', data),
  update: (id: number, data: UpdateSupplierCategoryInterface) => api.put(`suppliers-category/${id}`, data),
