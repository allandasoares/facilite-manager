...
const productVariationService = {
  ...
  create: (data: CreateProductVariationInterface) => api.post('/product-variations', data),
  update: (id: number, data: UpdateProductCategoryInterface) => api.put(`/product-variations/${id}`, data),
