...
export default function CreateVariationOptionsPage() {
  ...
  const { mutate: saveVariationOption } = useMutation(
    (data: CreateVariationOptionInterface) =>
      variationOptionsService.create({
        name: data.name,
  ...
  const { mutate: updateVariationOption } = useMutation(
    (data: any) =>
      variationOptionsService.update(data.variationOptionId!, {
        name: data.name,
        variationId: +variationId!,
      }),
    {
  ...
  const { data: variationsRes } = useQuery(
    ["variation-options", variationId],
